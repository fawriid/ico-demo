    ...
    return (
        <div className="page_container" id="#">
            <button className="logged_in-page">
                <Link to="/"><img src={p26} alt="png"/></Link>
            </button>
            {/* side bar menu */}
                ...
                <div className="main_content">
                    <div className="main_content-left">
                        <div className="content_left-top">
                            <div className="content_top-left-information">
                                {" "}
                                How to join ICO ?
                            </div>
                            <div className="joining_ico">
                                <div className="joining_ico-guide">
                                    <p>
                                        In order to inverst in the Initial Coint Offering
                                        you must:
                                    </p>
                                    <div>
                    ...
                    <div className="main_content-right">
                        ...
                        <div className="wallet_connection-status">
                            <div className="connection_status-alert">
                                <img src={p25} alt="png" />
                                <p className="accepted_color">Your Wallet Connected</p>
                            </div>
                                ...
                                <div>
                                    ...
                                    <select>
                                        <option value="BUSD" selected>
                                            {" "}
                                            <img src={p24} alt="png" /> BUSD
                                        </option>
                                    </select>
                                </div>
                                <div>
                                    <span>Amount</span>
                                    <input type="text" placeholder="10.000 BUSD" />
                                </div>
                            </div>
                            <div className="wallet_calculating">
                                (10.000NUSD / 0.04$) = <span>250.000 RISING</span>
                            </div>
